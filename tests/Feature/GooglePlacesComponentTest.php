...
class GooglePlacesComponentTest extends TestCase
{
    public function test_component_renders_model_values(): void
    {
        ...
        $publishedView = resource_path('views/vendor/mfw-google-places/components/google-places.blade.php');
        ...
        $html = Blade::render('<x-google-places :model="$model" />', [
            'model' => $model,
        ]);
